...
class LifMeshGenerator:
    def __init__(self, basename):
        self.tau             = 0.001     # membrane time constant in s
        self.V_threshold     = -50.01     # threshold in V
        self.epsilon         = 0.001     # padding as fraction of the threshold potential
        self.labda           = 0.0001      # fiducial bin size
        self.V_rest          = -65.0     # reversal/rest potential (also the reset potential)
        self.V_min           = -80.0       # guaranteed minimum value of the grid
        self.V_max           = -50.0     # guaranteed maximum value of the grid
