 ...
 */
static PyMethodDef WinMiindPythonCuda_functions[] = {
 ...
 */
int exec_WinMiindPythonCuda(PyObject* module) {
    PyModule_AddFunctions(module, WinMiindPythonCuda_functions);
 ...
 */
PyDoc_STRVAR(WinMiindPythonCuda_doc, "The WinMiindPython module");


static PyModuleDef_Slot WinMiindPythonCuda_slots[] = {
    { Py_mod_exec, exec_WinMiindPythonCuda },
    { 0, NULL }
};

static PyModuleDef WinMiindPythonCuda_def = {
    PyModuleDef_HEAD_INIT,
    "WinMiindPythonCuda",
    WinMiindPythonCuda_doc,
    0,              /* m_size */
    NULL,           /* m_methods */
    WinMiindPythonCuda_slots,
    NULL,           /* m_traverse */
    NULL,           /* m_clear */
    NULL,           /* m_free */
};

PyMODINIT_FUNC PyInit_WinMiindPythonCuda() {
    return PyModuleDef_Init(&WinMiindPythonCuda_def);
}
